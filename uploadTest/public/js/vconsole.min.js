...
!function (e, t) {
    ...
    return function (e) {
        ...
        }(), l = o(2), c = a(l), s = o(3), d = n(s), u = o(4), v = a(u);
        o(6);
        var f = o(10), p = a(f), h = o(11), b = a(h), g = o(12), m = a(g), y = o(13), _ = a(y), w = o(14), x = a(w),
            k = o(15), C = a(k), T = o(23), O = a(T), E = o(25), S = a(E), L = o(29), j = a(L), N = o(36), P = a(N),
            M = "#__vconsole", A = function () {
                function e(t) {
                    ...
                    if (this.version = c["default"].version, this.$dom = null, this.isInited = !1, this.option = {defaultPlugins: ["system", "network", "element", "storage"]}, this.activedTab = "", this.tabList = [], this.pluginList = {}, this.switchPos = {
                        ...
                        endX: 0,
                        endY: 0
                    }, this.tool = d, this.$ = v["default"], d.isObject(t)) for (var n in t) this.option[n] = t[n];
                ...
                return r(e, [{
                    ...
                    key: "_render", value: function () {
                        ...
                        var a = window.devicePixelRatio || 1, i = document.querySelector('[name="viewport"]');
                        if (i && i.content) {
                    ...
                    key: "_mockTap", value: function () {
                        var e = 700, t = 10, o = void 0, n = void 0, a = void 0, i = !1, r = null;
                        this.$dom.addEventListener("touchstart", function (e) {
                            ...
                            if (i === !1 && t.timeStamp - o < e && null != r) {
                                var n = r.tagName.toLowerCase(), a = !1;
                                switch (n) {
                                    case"textarea":
                                        a = !0;
                                        break;
                    ...
                    key: "_bindEvent", value: function () {
                        ...
                        v["default"].bind(t, "touchstart", function (t) {
                            ...
                            if (o.touches.length > 0) {
                                var n = o.touches[0].pageX - e.switchPos.startX,
                                    a = o.touches[0].pageY - e.switchPos.startY, i = e.switchPos.x - n,
                                    r = e.switchPos.y - a;
                        ...
                        v["default"].bind(o, "touchstart", function (e) {
                            var t = o.scrollTop, a = o.scrollHeight, i = t + o.offsetHeight;
                    ...
                    key: "_initPlugin", value: function (e) {
                        ...
                        e.vConsole = this, e.trigger("init"), e.trigger("renderTab", function (o) {
                            t.tabList.push(e.id);
                            var n = v["default"].render(b["default"], {id: e.id, name: e.name});
                            ...
                            if (o) for (var n = v["default"].one(".vc-topbar", t.$dom), a = function (t) {
                                var a = o[t], i = v["default"].render(_["default"], {
                                    name: a.name || "Undefined",
                                    className: a.className || "",
                                    pluginID: e.id
                                });
                                if (a.data) for (var r in a.data) i.dataset[r] = a.data[r];
                            ...
                            if (o) for (var n = v["default"].one(".vc-tool-last", t.$dom), a = function (t) {
                                var a = o[t],
                                    i = v["default"].render(x["default"], {name: a.name || "Undefined", pluginID: e.id});
        ...
        function o(e) {
            var t = e > 0 ? new Date(e) : new Date, o = t.getDate() < 10 ? "0" + t.getDate() : t.getDate(),
                n = t.getMonth() < 9 ? "0" + (t.getMonth() + 1) : t.getMonth() + 1, a = t.getFullYear(),
        ...
        function b(e) {
            var t = arguments.length <= 1 || void 0 === arguments[1] ? "	" : arguments[1],
                ...
                n = [], a = JSON.stringify(e, function (e, t) {
        ...
        l.one = function (e, t) {
            ...
            e && e.addEventListener(t, function (t) {
                var a = l.all(o, e);
                if (a) e:for (var i = 0; i < a.length; i++) for (var r = t.target; r;) {
                    if (r == a[i]) {
                        n.call(r, t);
                        break e
                    }
        ...
        function o(e, t, o) {
            var n = /\{\{([^\}]+)\}\}/g, a = "", i = "", r = 0, l = [], c = function (e, t) {
        ...
        function a(e) {
            for (var t = [], o = {}, n = 0; n < e.length; n++) {
                var a = e[n], i = a[0], r = a[1], l = a[2], c = a[3], s = {css: r, media: l, sourceMap: c};
        ...
        function v(e, t) {
            ...
            var a = new Blob([o], {type: "text/css"}), i = e.href;
        ...
        var c = function () {
            ...
            }, d = o(4), u = a(d), v = o(3), f = n(v), p = o(16), h = a(p), b = o(21), g = a(b), m = o(22), y = a(m),
            _ = function (e) {
                function t() {
                    var e;
                    i(this, t);
                ...
                return l(t, e), c(t, [{
                    key: "onReady", value: function () {
                        ...
                        var n = document.getElementsByTagName("script"), a = "";
                    ...
                    key: "evalCommand", value: function (e) {
                        ...
                        var i = window.__vConsole_cmd_result, r = window.__vConsole_cmd_error;
                        ...
                        } else this.printLog({logType: "error", logs: [i], noMeta: !0, style: ""})
                    }
                }]), t
            }(h["default"]);
        ...
        var c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            }(), d = o(3), u = a(d), v = o(4), f = n(v), p = o(17), h = n(p), b = o(18), g = n(b), m = o(19), y = n(m),
            _ = o(20), w = n(_), x = 1e3, k = function (e) {
                function t() {
                    var e;
                    i(this, t);
                    for (var o = arguments.length, n = Array(o), a = 0; o > a; a++) n[a] = arguments[a];
                ...
                return l(t, e), s(t, [{
                    ...
                    key: "onReady", value: function () {
                        ...
                        f["default"].bind(t, "click", function (o) {
                            ...
                            var n = this.dataset.type, a = f["default"].one(".vc-log", e.$tabbox);
                    ...
                    key: "getFoldedLine", value: function (e, t) {
                        var o = this;
                        if (!t) {
                            var n = u.JSONStringify(e), a = n.substr(0, 26);
        ...
        var c = function () {
            ...
            var i = n.get;
            if (void 0 !== i) return i.call(o)
        }, d = o(3), u = (a(d), o(16)), v = n(u), f = o(24), p = n(f), h = function (e) {
            function t() {
                var e;
                i(this, t);
                for (var o = arguments.length, n = Array(o), a = 0; o > a; a++) n[a] = arguments[a];
            ...
            return l(t, e), c(t, [{
                ...
                key: "printSystemInfo", value: function () {
                    var e = navigator.userAgent, t = "", o = e.match(/(ipod).*\s([\d_]+)/i),
                        n = e.match(/(ipad).*\s([\d_]+)/i), a = e.match(/(iphone)\sos\s([\d_]+)/i),
        ...
        var c = function () {
            ...
            }(), s = o(4), d = a(s), u = o(3), v = n(u), f = o(17), p = a(f), h = o(26), b = a(h), g = o(27), m = a(g),
            y = o(28), _ = a(y), w = function (e) {
                function t() {
                    var e;
                    i(this, t);
                    for (var o = arguments.length, n = Array(o), a = 0; o > a; a++) n[a] = arguments[a];
                ...
                return l(t, e), c(t, [{
                    ...
                    key: "updateRequest", value: function (e, t) {
                        ...
                        if (this.reqList[e] = n, this.isReady) {
                            ...
                            var l = d["default"].render(_["default"], i), c = this.domList[e];
                    ...
                    key: "mockAjax", value: function () {
                        ...
                        if (e) {
                            var t = this, o = window.XMLHttpRequest.prototype.open,
                                n = window.XMLHttpRequest.prototype.send;
                            t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                                var e = this, n = [].slice.call(arguments), a = n[0], i = n[1], r = t.getUniqueID(),
                                    l = null;
                                e._requestID = r, e._method = a, e._url = i;
                                var c = e.onreadystatechange || function () {
                                }, s = function () {
                                    var o = t.reqList[r] || {};
                                    if (o.readyState = e.readyState, o.status = e.status, o.responseType = e.responseType, 0 == e.readyState) o.startTime || (o.startTime = +new Date); else if (1 == e.readyState) o.startTime || (o.startTime = +new Date); else if (2 == e.readyState) {
                                        o.header = {};
                                ...
                                var e = this, o = [].slice.call(arguments), a = o[0], i = t.reqList[e._requestID] || {};
                                ...
                                if ("POST" == i.method) if (v.isString(a)) {
                                    var h = a.split("&");
                                    i.postData = {};
        ...
        o(30);
        var s = o(17), d = a(s), u = o(32), v = a(u), f = o(33), p = a(f), h = o(3), b = (n(h), o(4)), g = a(b),
            m = function (e) {
                function t() {
                    var e;
                    i(this, t);
                ...
                return l(t, e), c(t, [{
                    ...
                    key: "onChildRemove", value: function (e) {
                        ...
                        if (o) {
                            for (var n = 0; n < e.removedNodes.length; n++) {
                                var a = e.removedNodes[n], i = a.__vconsole_node;
                    ...
                    key: "onChildAdd", value: function (e) {
                        ...
                        if (o) {
                            ...
                            for (var n = 0; n < e.addedNodes.length; n++) {
                                var a = e.addedNodes[n], i = a.__vconsole_node;
                                if (i) if (null !== e.nextSibling) {
                    ...
                    key: "renderView", value: function (e, t, o) {
                        var n = this, a = new p["default"](e).get();
        ...
        var s = function () {
        ...
        }(), d = o(34), u = a(d), v = o(35), f = a(v), p = o(3), h = (n(p), o(4)), b = a(h), g = function () {
            function e(t) {
            ...
            return s(e, [{
                ...
                key: "_createElementNode", value: function (e, t) {
                    ...
                    if (n) b["default"].addClass(t, "vcelm-noc"), t.appendChild(a), o || t.appendChild(i); else {
                        t.appendChild(a);
        ...
        var c = function () {
            ...
            }(), s = o(17), d = a(s), u = o(37), v = a(u), f = o(38), p = a(f), h = o(3), b = n(h), g = o(4), m = a(g),
            y = function (e) {
                function t() {
                    var e;
                    i(this, t);
                ...
                return l(t, e), c(t, [{
                    ...
                    key: "getCookieList", value: function () {
                        ...
                        for (var e = [], t = document.cookie.split(";"), o = 0; o < t.length; o++) {
                            var n = t[o].split("="), a = n[0].replace(/^ /, ""), i = n[1];
                            e.push({name: decodeURIComponent(a), value: decodeURIComponent(i)})
                        }
                        return e
                    }
                }, {
