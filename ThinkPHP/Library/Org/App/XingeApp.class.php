...
class XingeApp
{
    ...
    public function __construct($type = 'ios')
    {
//        assert(isset($accessId) && isset($secretKey));
        if($type == 'ios'){
            $this->accessId = 2200279067;
            $this->secretKey = '8b19399464df51c6ef83b0e7c061567b';
        }else{
            $this->accessId = 2100279069;
            $this->secretKey = 'a30c11a4ebe28f08219fc2409e965925';
        }
    }
